package com.jason.crawler.thread;
...
import com.jason.crawler.util.FieldReflectionUtil;
 ...
 * crawler thread
 *
 * @author jason 2017-10-10 10:58:19
 */
            ...
            for (Element pageVoElement : pageVoElements) {
                ...
                if (fields!=null) {
                    for (Field field: fields) {
                        ...
                        CrawlerConf.SelectType selectType = null;
